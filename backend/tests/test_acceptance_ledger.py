...
def test_f011_real_provider_uat_cannot_exceed_eight_calls(
    ledger: AcceptanceLedger,
) -> None:
    for _ in range(8):
        settle(
...
def test_f012_real_provider_uat_cannot_exceed_eight_calls(
    ledger: AcceptanceLedger,
) -> None:
    for _ in range(8):
        settle(
...
def test_f014_real_provider_uat_cannot_exceed_eight_calls(
    ledger: AcceptanceLedger,
) -> None:
    for _ in range(8):
        settle(
...
def test_f011_real_provider_uat_cost_limit_is_enforced_before_dispatch(
    ledger: AcceptanceLedger,
) -> None:
    for _ in range(4):
        reservation = reserve(
...
def test_f012_real_provider_uat_cost_limit_is_enforced_before_dispatch(
    ledger: AcceptanceLedger,
) -> None:
    for _ in range(4):
        reservation = reserve(
...
def test_f014_real_provider_uat_cost_limit_is_enforced_before_dispatch(
    ledger: AcceptanceLedger,
) -> None:
    for _ in range(4):
        reservation = reserve(
